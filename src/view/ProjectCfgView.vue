      ...
      <Fieldset class="text-xl" legend="Repository configuration" toggleable>
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2">
            ...
            <Message class="text-gray-500 text-sm" severity="secondary" size="small" variant="simple">Enter the GitHub
              branch.
            </Message>
          </div>
          <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-2">
            ...
            <Message class="text-gray-500 text-sm" severity="secondary" size="small" variant="simple">Enter the local
              repository path.
            </Message>
          </div>
        </div>
      ...
      <Fieldset class="text-xl" legend="Command configuration" toggleable>
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2 mb-4">
            ...
            <Message class="text-gray-500 text-sm" severity="secondary" size="small" variant="simple">Enter the build
              command.
            </Message>
          </div>
          <div class="flex flex-col gap-2 mb-4">
            ...
            <Message class="text-gray-500 text-sm" severity="secondary" size="small" variant="simple">Enter the run
              command.
            </Message>
          </div>
          <div class="flex flex-col gap-2">
            ...
            <Message class="text-gray-500 text-sm" severity="secondary" size="small" variant="simple">Enter the debug
              command.
            </Message>
          </div>
        </div>
        ...
        <DataTable :value="currentProject.startupDependencies" class="text-base">
          <Column class="uppercase" field="id" header="Id">
            <template #body="slotProps">
              <router-link v-if="slotProps.data.id" v-slot="{ href, navigate }" :to="'/project/'+slotProps.data.id"
                           custom>
